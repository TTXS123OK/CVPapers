...
- **Arxiv ID**: http://arxiv.org/abs/2505.08819v1
- **DOI**: None
- **Categories**: **eess.IV**, cs.CV, cs.LG
- **Links**: [PDF](http://arxiv.org/pdf/2505.08819v1)
- **Published**: 2025-05-12 18:40:46+00:00
- **Updated**: 2025-05-12 18:40:46+00:00
- **Authors**: Asahi Miyazaki, Tsuyoshi Okita
- **Comment**: 9 pages, 11 figures
- **Journal**: None
- **Summary**: Masked image modeling is one of the most poplular objectives of training. Recently, the SparK model has been proposed with superior performance among self-supervised learning models. This paper proposes a new mask pattern for this SparK model, proposing it as the Mesh Mask-ed SparK model. We report the effect of the mask pattern used for image masking in pre-training on performance.
