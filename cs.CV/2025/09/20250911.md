...
- **Comment**: None
- **Journal**: Yushen Xu,Xiaosong Li,Yuchun Wang,Xiaoqi Cheng,Huafeng Li,Haishu
  Tan. FlexiD-Fuse: Flexible number of inputs multi-modal medical image fusion
  based on diffusion model[J]. Expert Systems with Applications, 2025: 128895
