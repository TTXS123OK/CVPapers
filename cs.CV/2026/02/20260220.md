...
- **Arxiv ID**: http://arxiv.org/abs/2602.18527v1
- **DOI**: None
- **Categories**: **cs.CV**, cs.AI, cs.SD
- **Links**: [PDF](https://arxiv.org/pdf/2602.18527v1)
- **Published**: 2026-02-20 04:06:07+00:00
- **Updated**: 2026-02-20 04:06:07+00:00
...
- **Arxiv ID**: http://arxiv.org/abs/2602.18532v1
- **DOI**: None
- **Categories**: **cs.CV**, cs.AI, cs.RO
- **Links**: [PDF](https://arxiv.org/pdf/2602.18532v1)
- **Published**: 2026-02-20 09:26:17+00:00
- **Updated**: 2026-02-20 09:26:17+00:00
...
- **Arxiv ID**: http://arxiv.org/abs/2602.18606v1
- **DOI**: None
- **Categories**: **cs.RO**, cs.CV
- **Links**: [PDF](https://arxiv.org/pdf/2602.18606v1)
- **Published**: 2026-02-20 20:49:07+00:00
- **Updated**: 2026-02-20 20:49:07+00:00
...
- **Arxiv ID**: http://arxiv.org/abs/2602.18614v1
- **DOI**: None
- **Categories**: **cs.CV**
- **Links**: [PDF](https://arxiv.org/pdf/2602.18614v1)
- **Published**: 2026-02-20 21:07:59+00:00
- **Updated**: 2026-02-20 21:07:59+00:00
- **Authors**: Massoud Dehghan, Ramona Woitek, Amirreza Mahbod
- **Comment**: 29 pages
- **Journal**: None
- **Summary**: Vision Transformers (ViTs) and their variants have become state-of-the-art in many computer vision tasks and are widely used as backbones in large-scale vision and vision-language foundation models. While substantial research has focused on architectural improvements, the impact of patch size, a crucial initial design choice in ViTs, remains underexplored, particularly in medical domains where both two-dimensional (2D) and three-dimensional (3D) imaging modalities exist.   In this study, using 12 medical imaging datasets from various imaging modalities (including seven 2D and five 3D datasets), we conduct a thorough evaluation of how different patch sizes affect ViT classification performance. Using a single graphical processing unit (GPU) and a range of patch sizes (1, 2, 4, 7, 14, 28), we fine-tune ViT models and observe consistent improvements in classification performance with smaller patch sizes (1, 2, and 4), which achieve the best results across nearly all datasets. More specifically, our results indicate improvements in balanced accuracy of up to 12.78% for 2D datasets (patch size 2 vs. 28) and up to 23.78% for 3D datasets (patch size 1 vs. 14), at the cost of increased computational expense. Moreover, by applying a straightforward ensemble strategy that fuses the predictions of the models trained with patch sizes 1, 2, and 4, we demonstrate a further boost in performance in most cases, especially for the 2D datasets. Our implementation is publicly available on GitHub: https://github.com/HealMaDe/MedViT



### Narrating For You: Prompt-guided Audio-visual Narrating Face Generation Employing Multi-entangled Latent Space
- **Arxiv ID**: http://arxiv.org/abs/2602.18618v1
- **DOI**: None
- **Categories**: **cs.CV**
- **Links**: [PDF](https://arxiv.org/pdf/2602.18618v1)
- **Published**: 2026-02-20 21:14:18+00:00
- **Updated**: 2026-02-20 21:14:18+00:00
- **Authors**: Aashish Chandra, Aashutosh A, Abhijit Das
- **Comment**: To appear in the Proceedings of the IEEE/CVF Winter Conference on Applications of Computer Vision (WACV) 2026. Presented at Poster Session 1
- **Journal**: None
